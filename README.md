...
- [danielgatis/go-ruby-prism](https://github.com/danielgatis/go-ruby-prism) ([v1.2.0](https://github.com/danielgatis/go-ruby-prism/releases/tag/v1.2.0), today) - The Ruby Prism parser bindings to GO (without cgo)
...
- [Fix parser reuse memory bugs, pool WASM instances, upgrade prism to 1.9.0](https://github.com/danielgatis/go-ruby-prism/pull/5) on [danielgatis/go-ruby-prism](https://github.com/danielgatis/go-ruby-prism) (today)
