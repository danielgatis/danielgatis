...
- [danielgatis/rembg](https://github.com/danielgatis/rembg) ([v2.0.73](https://github.com/danielgatis/rembg/releases/tag/v2.0.73), 5 days ago) - Rembg is a tool to remove images background
...
- [GreenmaskIO/greenmask](https://github.com/GreenmaskIO/greenmask) - Database anonymization and synthetic data generation tool (2 days ago)
