...
- [danielgatis/rembg](https://github.com/danielgatis/rembg) ([v2.0.58](https://github.com/danielgatis/rembg/releases/tag/v2.0.58), 2 days ago) - Rembg is a tool to remove images background
...
- [di-sukharev/opencommit](https://github.com/di-sukharev/opencommit) - Generate awesome commits with AI in 1 second 🤯🔫 (6 days ago)
...
- [adrg/sysfont](https://github.com/adrg/sysfont) - Golang identification and matching of system fonts (3 weeks ago)
- [adrg/xdg](https://github.com/adrg/xdg) - Go implementation of the XDG Base Directory Specification and XDG user directories (3 weeks ago)
