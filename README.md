...
- [danielgatis/go-vte](https://github.com/danielgatis/go-vte) ([v1.0.8](https://github.com/danielgatis/go-vte/releases/tag/v1.0.8), today) - A library to parse terminal escape sequences (almost) exactly how the real hardware does.
- [danielgatis/go-ansicode](https://github.com/danielgatis/go-ansicode) ([v1.0.4](https://github.com/danielgatis/go-ansicode/releases/tag/v1.0.4), 4 days ago) - go-ansicode is a package that interprets ANSI codes and allows you to register a handler to deal with the operations
