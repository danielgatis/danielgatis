...
- [danielgatis/go-headless-term](https://github.com/danielgatis/go-headless-term) ([v1.0.6](https://github.com/danielgatis/go-headless-term/releases/tag/v1.0.6), 2 days ago) - Headless, but fully terminal
- [danielgatis/go-ansicode](https://github.com/danielgatis/go-ansicode) ([v1.0.12](https://github.com/danielgatis/go-ansicode/releases/tag/v1.0.12), 2 days ago) - go-ansicode is a package that interprets ANSI codes and allows you to register a handler to deal with the operations
