...
- [danielgatis/go-findfont](https://github.com/danielgatis/go-findfont) - Find system fonts through the fontconfig library (a.k.a `fc-match`). (2 days ago)
...
- [danielgatis/go-headless-term](https://github.com/danielgatis/go-headless-term) ([v1.0.2](https://github.com/danielgatis/go-headless-term/releases/tag/v1.0.2), today) - Headless, but fully terminal
...
- [danielgatis/go-doom](https://github.com/danielgatis/go-doom) ([v1.0.0](https://github.com/danielgatis/go-doom/releases/tag/v1.0.0), 5 days ago) - Play classic DOOM in pure Go! Single binary with embedded game data, cross-platform, zero dependencies.
...
- [vito/midterm](https://github.com/vito/midterm) - a pretty mid terminal emulator (2 days ago)
- [danielgatis/go-doom](https://github.com/danielgatis/go-doom) - Play classic DOOM in pure Go! Single binary with embedded game data, cross-platform, zero dependencies. (5 days ago)
...
- [ozkl/doomgeneric](https://github.com/ozkl/doomgeneric) - Easily portable doom (6 days ago)
