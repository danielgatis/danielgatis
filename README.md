...
- [danielgatis/diagnes-agent-releases](https://github.com/danielgatis/diagnes-agent-releases) ([v1.0.28](https://github.com/danielgatis/diagnes-agent-releases/releases/tag/v1.0.28), 3 days ago) - Diagnes Agent Public Releases
...
- [Kiranism/next-shadcn-dashboard-starter](https://github.com/Kiranism/next-shadcn-dashboard-starter) - Admin Dashboard Starter with Nextjs 15 and Shadcn ui (3 days ago)
