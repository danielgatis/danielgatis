...
- [danielgatis/rembg](https://github.com/danielgatis/rembg) ([v2.0.75](https://github.com/danielgatis/rembg/releases/tag/v2.0.75), 1 week ago) - Rembg is a tool to remove images background
...
- [GreenmaskIO/greenmask](https://github.com/GreenmaskIO/greenmask) - Database anonymization, synthetic data generation and logical dump (4 weeks ago)
