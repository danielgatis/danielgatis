...
- [danielgatis/diagnes-agent-releases](https://github.com/danielgatis/diagnes-agent-releases) ([v1.0.6](https://github.com/danielgatis/diagnes-agent-releases/releases/tag/v1.0.6), 2 days ago) - Diagnes Agent Public Releases
- [danielgatis/rembg](https://github.com/danielgatis/rembg) ([v2.0.65](https://github.com/danielgatis/rembg/releases/tag/v2.0.65), 5 days ago) - Rembg is a tool to remove images background
